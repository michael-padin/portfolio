        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-16">
          ...
          <div>
            <p className="text-text-secondary text-lg leading-relaxed mb-4">
              ...
              {" "}— a full-stack JavaScript developer with 3+ years building production-grade
              web apps and APIs. Currently working remotely for{" "}
              <a
              ...
              , where I architect backend pipelines, lead frontend migrations,
              and help plan technical decisions across a 5-app Turborepo monorepo.
            </p>
            <p className="text-text-secondary text-lg leading-relaxed mb-8">
              I specialise in the React and Node.js ecosystem with a strong focus on
              performance and shipping things that actually work. Fluent in English,
              comfortable with async-first workflows, and overlap with US and APAC
              timezones from {profile.timezone}.
            </p>
                ...
                {profile.experience.map((exp, i) => (
                  <div key={i} className="relative pl-10">
                    ...
                    <div className={`absolute left-0 top-1.5 w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                      ...
                      style={{ background: exp.current ? "var(--color-accent-subtle)" : "var(--color-bg)" }}>
                    ...
                    <div className="card p-4">
                      <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                        <div>
                          {exp.companyUrl ? (
                            ...
                            <div className="font-semibold text-text-primary text-sm">{exp.company}</div>
                          )}
                          <div className="text-accent text-xs font-mono">{exp.role}</div>
                        </div>
                        <div className="text-right" style={{ color: "var(--color-text-muted)", fontSize: "0.65rem" }}>
                      ...
                      <ul className="space-y-1.5">
                        {exp.highlights.map((h, j) => (
                          <li key={j} className="text-text-secondary text-xs leading-relaxed flex gap-2">
              ...
              <div key={i} className="mt-6 card p-4" style={{ borderColor: "rgba(0,212,170,0.2)" }}>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-text-secondary text-xs">{edu.degree} · {edu.period}</div>
