  ...
  return (
    <section className="py-24">
      <div className="container-custom">
        <div className="relative rounded-3xl border overflow-hidden p-12 md:p-16 text-center"
          style={{
            borderColor: "rgba(0,212,170,0.2)",
            background: "linear-gradient(135deg, rgba(0,212,170,0.05) 0%, var(--color-bg-secondary) 50%, var(--color-bg-secondary) 100%)",
          }}>
          {/* Glow */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-text-secondary text-lg max-w-xl mx-auto mb-10">
              ...
              {" "}Based in {profile.location} ({profile.timezone}) — I work flexible hours to overlap with your team.
            </p>
