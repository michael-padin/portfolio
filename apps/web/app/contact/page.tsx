...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Michael Padin for freelance projects or full-time remote opportunities.",
};
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-text-secondary text-lg leading-relaxed mb-4">
              ...
              possibilities — I typically reply within 24 hours.
            </p>
            {/* Live availability badge */}
            <div className="flex items-center gap-2">
              <span className={`w-2 h-2 rounded-full animate-pulse ${available ? "bg-success" : "bg-amber-400"}`} />
